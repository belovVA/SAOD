...
void inser_sort() {
    ...
    changes = changes / 3; // изначально считаются кол-во пересылок, но делением на 3 мы получаем кол-во перестановок
    cout << "\nМассив отсортирован";
    show(b);
    cout << "\nКол-во сравнений: " << compares;
    cout << "\nКол-во перестановок: " << changes;
...
void choice_sort() {
    ...
    Найденный максимум меняем местами с первым элементом.
